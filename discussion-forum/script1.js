document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch(`https://hd-sih-forum-de6q.onrender.com/api/discussions/get-discussion-by-id/${discussionId}`,
        {
            credentials:"include"
        }
    )
...
function fetchComments(discussionId) {
    ...
    fetch(`https://hd-sih-forum-de6q.onrender.com/api/comments/get-discussion-comments/${discussionId}`)
        .then(response => response.json())
        .then(comments => {
...
function postComment(discussionId, commentText) {
    ...
    fetch(`https://hd-sih-forum-de6q.onrender.com/api/comments/add-comment`, {
        method: 'POST',
        credentials:"include",
        headers: {
